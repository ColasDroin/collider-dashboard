...
def all_callbacks(app, dic_with_bb, dic_without_bb, path_collider):
    ...
    # @app.callback(
    #     Output("id-df-after-bb", "data"),
    #     Input("segmented-data-table", "value"),
    #     Input("id-df-after-bb", "page_current"),
    #     Input("id-df-after-bb", "page_size"),
    #     Input("id-df-after-bb", "sort_by"),
    #     Input("id-df-after-bb", "filter_query"),
    # )
    # def update_table(value, page_current, page_size, sort_by, filter):
    #     match value:
    #         case "Twiss table beam 1":
    #             dff = dic_with_bb["df_tw_b1"]
    #         case "Survey table beam 1":
    #             dff = dic_with_bb["df_sv_b1"]
    #         case "Twiss table beam 2":
    #             dff = dic_with_bb["df_tw_b2"]
    #         case "Survey table beam 2":
    #             dff = dic_with_bb["df_sv_b2"]
    #         case _:
    #             dff = dic_with_bb["df_tw_b1"]
